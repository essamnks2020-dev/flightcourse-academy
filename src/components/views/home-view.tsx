...
export function HomeView() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* ============================================================ */}
      {/* Section 7 — Game source downloads (for AI restyling)          */}
      {/* ============================================================ */}
      <section className="border-border border-t">
        <div className="mx-auto w-full max-w-5xl px-4 py-20 sm:px-6">
          <div className="flex flex-col gap-3">
            <p className="label-instrument text-primary">For developers</p>
            <h2 className="text-balance text-3xl font-semibold tracking-tight sm:text-4xl">
              Download game source code
            </h2>
            <p className="text-muted-foreground max-w-2xl leading-relaxed">
              Each zip contains the full source code for one game plus the Glass Cockpit
              design system. Send the zip and its prompt to another AI to restyle the game.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              {
                name: "Flare Trainer",
                file: "flare-trainer-source.zip",
                desc: "Landing physics game — 9 source files + design system",
                icon: Plane,
              },
              {
                name: "Radio Builder",
                file: "radio-builder-source.zip",
                desc: "ATC call construction — 13 source files + design system",
                icon: Radio,
              },
              {
                name: "Pattern Perfect",
                file: "pattern-perfect-source.zip",
                desc: "Traffic pattern sim — 11 source files + design system",
                icon: Map,
              },
            ].map((g) => (
              <a
                key={g.name}
                href={`/game-sources/${g.file}`}
                download
              ...
              >
                ...
                <span className="text-accent mt-auto inline-flex items-center gap-1.5 text-sm font-medium">
                  Download
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              href="/game-sources/FlightCourse-Games-Full-Bundle.zip"
              download
              className="fp-outline-btn px-5 py-3 text-sm"
            >
              Download all 3 games in one zip (122 KB)
              <ArrowRight className="size-4" aria-hidden="true" />
            </a>
            <a
              href="/game-sources/README.md"
              download
              className="text-muted-foreground text-sm hover:text-foreground hover:underline"
            >
              Download README with all 3 prompts
            </a>
          </div>
        </div>
      </section>
