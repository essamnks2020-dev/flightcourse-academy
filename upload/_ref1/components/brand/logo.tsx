...
/**
 * FlightCourse Academy mark: an attitude indicator (artificial horizon) whose
 * horizon line doubles as a rising flight path. Reads as both an instrument
 * and a "course" being flown.
 */
